                ...
                {user?.userArmor.map((item, index) => (
                  ...
                  <li className="flex" key={index}>
                    <a href="#" className="group relative rounded-lg border border-gray-700 hover:border-white w-auto transition-colors duration-150">
                      ...
                      <span className="absolute bottom-full left-1/2 -translate-x-1/2 top-1/2 mb-2 z-10 hidden group-hover:block w-max max-w-xs bg-gray-900 text-white text-xs font-medium px-3 py-1 rounded-md shadow-lg whitespace-nowrap">
                        {item?.displayProperties?.name || "Weapon Details"} {/* Use actual item name */}
                        {/* You can add more details here */}
                      </span> 
                    </a>
