        ...
        <Disclosure as="nav" className="bg-transparent">
            {/* Visible Header Parent */}
                <div className="flex h-16 items-center mr-5 ml-5">
                    <Bars3Icon aria-hidden="true" className="block size-7 group-data-open:hidden hover:bg-gray-100 hover:text-gray-100 border-white border-2 rounded-sm" />
                    <XMarkIcon aria-hidden="true" className="hidden size-7 group-data-open:block hover:bg-gray-100 hover:text-gray-100 border-white border-2 rounded-sm" />
